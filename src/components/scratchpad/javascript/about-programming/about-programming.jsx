...
fakeRichieSambora instanceof GuitarPlayer; // false`}
  ...
  play() {
    console.log('Rock!');
      ...
      <p>Названия свойствам и методам разработчик придумывает самостоятельно. Всем, кроме служебного метода constructor. JavaScript выполнит этот метод при создании экземпляра класса c помощью new:</p>
