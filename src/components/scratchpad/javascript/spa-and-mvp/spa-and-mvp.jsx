...
function SPAAndMVP() {
  ...
  return (
    <section className="conspect">
      ...
      <p className="hl-2">ООП это принципы и ограничения, по которым мы пишем и организовываем код. ООП решает проблемы организации кода. MVP — организации приложения</p>

      <h3>Проблема</h3>
      <p>Многие компоненты приложения динамичны и должны реагировать на действия пользователя. ООП не решает этих проблем</p>

      <p className="hl-3">MVC - Способ организации логики в приложении</p>
      <p className="hl-3">MVP - Частный вариант MVC</p>

      <h3>Разница между MVC и MVP</h3>
      <p className="hl-6">Паттерны MV* отличаются нюансами связывания, но цель у них одна. Связывание бывает двустороннее и одностороннее.</p>
      <img src="img/mvc-and-mvp.png" alt="" width="890" height="572" />

      <p className="hl-1">В MVP презентер играет решающую роль в связывании, потому что связывает между собой модель и представление</p>
      ...
      <h3>MVP в приложении</h3>
      <img src="img/mvp-3.png" alt="" width="890" height="615" />
      <img src="img/mvp-4.png" alt="" width="890" height="615" />
