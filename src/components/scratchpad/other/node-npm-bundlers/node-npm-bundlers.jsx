...
function NodeNpmBundlers() {
  ...
  return (
    <section className="conspect">
      ...
      <h2>About npm</h2>
      <p><span className="hl-10">npm (node package manager)</span> -  это менеджер зависимостей, автоматически устанавливающийся вместе с Node.js. Он используется для скачивания пакетов из облачного сервера npm, либо для загрузки пакетов на эти сервера. Позволяет разработчикам устанавливать пакеты как глобально, так и локально.</p>
