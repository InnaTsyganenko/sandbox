...
function MethodsForConstructingGridsOnGrid() {

  return (
    <section className="conspect">
      <h1>Методика построения сеток на гридах</h1>
...
/* … */
      ...
      <ul>
        ...
        <li>футер должен быть всегда прижат к низу, даже если контент не заполняет всю высоту окна браузера.</li>
      </ul>
...
export default MethodsForConstructingGridsOnGrid;
