...
.post .title {…} /* теги с классом title внутри тегов с классом post */`}
  ...
  <li><span>...</span></li>
      ...
      <p className="hl-8">Псевдоэлементы служат для обращения к отдельным частям элементов, тогда как псевдоклассы позволяют стилям различать разные типы элементов. Псевдоэлементы пишутся с двойным двоеточием. Этим они отличаются от псевдоклассов, которые используют одинарное двоеточие.</p>
