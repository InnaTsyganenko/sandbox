        ...
        <nav className="main-nav-scratchpad">
          <ul className="main-nav-scratchpad__list">
            <li className="main-nav-scratchpad__item">
              <Link className="main-nav-scratchpad__link" to={`${AppRoute.SCRATCHPAD}${AppRoute.HTML}`}>
            ...
            <li className="main-nav-scratchpad__item">
              <Link className="main-nav-scratchpad__link" to={`${AppRoute.SCRATCHPAD}${AppRoute.CSS}`}>
            ...
            <li className="main-nav-scratchpad__item">
              <Link className="main-nav-scratchpad__link" to={`${AppRoute.SCRATCHPAD}${AppRoute.JS}`}>
                <svg className="main-nav-scratchpad__link-icon" width={90} height={90} fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="main-nav-scratchpad__item">
              <Link className="main-nav-scratchpad__link" to={`${AppRoute.SCRATCHPAD}${AppRoute.REACT}`}>
            ...
            <li className="main-nav-scratchpad__item">
              <Link className="main-nav-scratchpad__link" to={`${AppRoute.SCRATCHPAD}${AppRoute.PHP}`}>
                <svg className="main-nav-scratchpad__link-icon" width={90} height={91} fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="main-nav-scratchpad__item">
              <Link className="main-nav-scratchpad__link" to={`${AppRoute.SCRATCHPAD}${AppRoute.OTHER}`}>
