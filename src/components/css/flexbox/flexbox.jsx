...
function Flexbox() {
  ...
  return (
    <section className="conspect">
      <h1>Flexbox</h1>
      <h2>Свойство display: flex, flex-элемент</h2>
      <p>Флексбокс — это первый CSS-механизм, предназначенный для построения сеток и создания сложных раскладок блоков.</p>
      <p>Элемент с display: flex; превращается во «флекс-контейнер» и внутри него начинает происходить вся магия гибкой раскладки. Непосредственные потомки этого элемента превращаются во «флекс-элементы» и начинают играть по новым правилам.</p>
      <ul>
