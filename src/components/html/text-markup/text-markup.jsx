...
function TextMarkup() {
  ...
  return (
    <section className="conspect">
      ...
      <pre>{`<blockquote></code>
  <code><p></code>Ум ценится дорого, когда дешевеет сила.<code></p></code>
  <code><cite></code>Джейсон Стэтхэм<code></cite></code>
<code></blockquote>`}
      </pre>
