...
function Bem() {
  ...
  return (
    <section className="conspect">
      ...
      <p><a href="http://yoksel.github.io/easy-markup/bem-rules/" target="_blank" rel="noopener noreferrer">Как писать классы по БЭМ?</a></p>
      ...
      <ol>
        ...
        <li>Элемент отделяется от блока двумя подчеркиваниями (__). Модификатор — двумя чёрточками(--).</li>
      ...
      <ul>
        ...
        <li>Имя модификатора блока — <span className="hl-5">header__theme--green-forest</span> — модификатор theme в значении green-forest блока header.</li>
        <li>Имя модификатора элемента — <span className="hl-5">header__search-form--disabled</span> — булев модификатор disabled элемента search-form блока header.</li>
      </ul>
