...
<label>
    ...
    Second checkbox
      ...
      <h2>Поиск в деревьях</h2>
      <p>Структура, которую представляет HTML-документ, а соответственно и DOM, является деревом.</p>
      ...
      <p>JavaScript для обхода DOM использует поиск в глубину.</p>
