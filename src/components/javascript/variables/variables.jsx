...
function Variables() {
  ...
  return (
    <section className="conspect">
      ...
      <p>Переменную можно представить в виде подписанной коробки. В любую коробку можно что-то поместить, а затем из неё достать. Надпись на коробке (имя переменной) поможет найти нужную, если одинаковых коробок будет много. Переменную можно создать, или объявить, с помощью ключевых слов <span className="hl-7">var, let, const)</span>. За ним следует имя переменной.</p>
...
`}
      ...
      <h4>Краткость</h4>
      <p>Не следует использовать сокращения. Исключение — общепринятые сокращения:</p>
      <ul>
      ...
      <p>Можно создать или объявить переменную и не сохранять в неё никакие данные, иногда это делают, чтобы «застолбить» имя переменной на будущее.</p>
