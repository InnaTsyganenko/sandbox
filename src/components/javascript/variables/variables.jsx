...
function Variables() {
  ...
  return (
    <section className="conspect">
      <h1>Переменные</h1>
      <p>Переменная — способ сохранить данные, дав им понятное название.</p>
      <p>Переменную можно создать, или объявить, с помощью ключевого слова <span className="hl-7">let (var, const)</span>. За ним следует имя переменной.</p>
      ...
      <p>Имя переменной может быть почти любым, но не должно начинаться с цифры, а из спецсимволов разрешены только &apos;_&apos; и &apos;$&apos;. Ещё для именования переменных нельзя использовать зарезервированные слова. Имена переменных чувствительны к регистру: header, Header и HEADER — это разные переменные.</p>
...
`}
      ...
      <p>Что такое блок кода? Если неформально — это любой участок скрипта, ограниченный фигурными скобками &lcub;&rcub;. Исключение — объекты, о них мы поговорим в будущих разделах.</p>
