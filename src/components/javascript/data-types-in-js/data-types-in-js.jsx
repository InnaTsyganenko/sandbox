...
`}
      ...
      <h3>Symbol</h3>
      <p>Символ (анг. Symbol) — это уникальный и неизменяемый тип данных, который может быть использован как идентификатор для свойств объектов. Символьный объект (анг. symbol object) — это объект-обёртка (англ. wrapper) для примитивного символьного типа.</p>

      <h2>Сложные типы данных</h2>
...
`}
      ...
      <pre>{`
  console.log('Вася' && 'Петя') // 'Вася' приводится к true, так что выведется 'Вася'
`}
      </pre>
